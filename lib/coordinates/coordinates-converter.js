...
import { TopocentricHorizontalSphericalCoordinates } from "./types/topocentric-horizontal-spherical-coordinates.js";
...
export class CoordinatesConverter {
   ...
   */
  static eclipticRectangularToEclipticSphericalCoordinates(
   ...
   */
  static eclipticSphericalToEquatorialSphericalCoordinates(
   ...
   * @returns {TopocentricHorizontalSphericalCoordinates}
   */
  static topocentricEquatorialToTopocentricHorizontalSphericalCoordinates(
    ...
    return new TopocentricHorizontalSphericalCoordinates(
      azimuth,
      altitude,
      null,
